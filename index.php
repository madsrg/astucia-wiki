        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-footer">
                ...
                <div class="sidebar-footer-icons">
                    ...
                    <?php endif; ?>
                    <?php /* Collapsed only: the rail hides .user-info, and with it the one way out.
                            The expanded footer already has the text link, so this must not double it. */ ?>
                    <?php if ($isAnonymous): ?>
                    <a href="auth.php" class="sidebar-icon-btn sidebar-rail-only" data-i18n-title="nav.login" title="Login">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg>
                    </a>
                    <?php elseif (AUTHENTICATION_ENABLED && isset($_SESSION['user'])): ?>
                    <a href="auth.php?action=logout" class="sidebar-icon-btn sidebar-rail-only" data-i18n-title="nav.logout" title="Logout">
